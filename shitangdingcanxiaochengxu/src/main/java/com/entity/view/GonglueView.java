 ...
 */
@TableName("gonglue")
public class GonglueView extends GonglueEntity implements Serializable {
	...
	public GonglueView(GonglueEntity gonglueEntity) {
		try {
			BeanUtils.copyProperties(this, gonglueEntity);
