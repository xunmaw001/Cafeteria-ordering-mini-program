...
public class GonglueController {
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(gonglue !=null){
            ...
            BeanUtils.copyProperties( gonglue , view );//把实体数据重构到view中
                ...
                //级联表
                YonghuEntity yonghu = yonghuService.selectById(gonglue.getYonghuId());
                if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody GonglueEntity gonglue, HttpServletRequest request){
        ...
        if(false)
            ...
            gonglue.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<GonglueEntity> queryWrapper = new EntityWrapper<GonglueEntity>()
            .eq("gonglue_name", gonglue.getGonglueName())
            .eq("gonglue_types", gonglue.getGonglueTypes())
            .eq("yonghu_id", gonglue.getYonghuId())
    ...
    */
    ...
    public R update(@RequestBody GonglueEntity gonglue, HttpServletRequest request){
...
//                            gonglueEntity.setGonglueTypes(Integer.valueOf(data.get(0)));   //攻略类型 要改的
//                            gonglueEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
