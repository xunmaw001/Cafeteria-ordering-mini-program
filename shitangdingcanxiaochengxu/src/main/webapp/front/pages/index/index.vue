<template>
	<view class="uni-padding-wrap">
		...
		<view class="pl15 col3 header-title" style="padding: 0 12px;box-sizing: border-box;"
			:style='{"backgroundColor":"#8E2DE2","borderColor":"#A27DE3","color":"rgba(255, 255, 255, 1)","borderRadius":"200rpx","borderWidth":"4rpx","fontSize":"32rpx","lineHeight":"72rpx","borderStyle":"dashed"}'>
		...
		<view class="list" :style='{"borderRadius":0,"backgroundColor":"#efefef"}'>
			<view :style='{"borderRadius":"8rpx","backgroundColor":"#A27DE3"}' @tap="onNewsDetailTap(item.id)"
		...
		<view v-if='2 == 1 || 2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''"
			...
			<view @tap="onDetailTap('caipin',product.id)" :style='{"borderRadius":"12rpx","backgroundColor":"#A27DE3"}'
				class="uni-product" v-for="(product,index) in caipinList1" :key="index">
		...
		<view v-if='2 == 1 || 2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''"
			...
			<view @tap="onDetailTap('shangjia',product.id)"
				:style='{"borderRadius":"12rpx","backgroundColor":"#A27DE3"}' class="uni-product"
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			let caipin1 = await this.$api.list('caipin', {
				page: 1,
				limit: 6,
				orderBy:"caipin_clicknum",
				shangxiaTypes: 1,
				caipinDelete: 1,
			});
			this.caipinList1 = caipin1.data.list
