        ...
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品编号" prop="caipinUuidNumber">
                       <el-input v-model="ruleForm.caipinUuidNumber"
                                 placeholder="商品编号" clearable  :readonly="ro.caipinUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="商品介绍" prop="caipinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.caipinContent" label="商品介绍" prop="caipinContent">
