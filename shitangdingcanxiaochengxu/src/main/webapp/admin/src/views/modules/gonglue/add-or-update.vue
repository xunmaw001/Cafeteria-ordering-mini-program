    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="攻略名称" prop="gonglueName">
                       <el-input v-model="ruleForm.gonglueName"
                                 placeholder="攻略名称" clearable  :readonly="ro.gonglueName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="攻略名称" prop="gonglueName">
                           <el-input v-model="ruleForm.gonglueName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gongluePhoto" label="封面" prop="gongluePhoto">
                        <file-upload
                            tip="点击上传封面"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.gongluePhoto?ruleForm.gongluePhoto:''"
                            @change="gongluePhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gongluePhoto" label="封面" prop="gongluePhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.gongluePhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="攻略类型" prop="gonglueTypes">
                        <el-select v-model="ruleForm.gonglueTypes" :disabled="ro.gonglueTypes" placeholder="请选择攻略类型">
                            <el-option
                                v-for="(item,index) in gonglueTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="攻略类型" prop="gonglueValue">
                        <el-input v-model="ruleForm.gonglueValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="攻略介绍" prop="gonglueContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gonglueContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gonglueContent" label="攻略介绍" prop="gonglueContent">
                            <span v-html="ruleForm.gonglueContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   gonglueContent: [
                              { required: true, message: '攻略介绍不能为空', trigger: 'blur' },
                          ],
                   gonglueDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gonglue_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gonglueTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`gonglue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.gonglueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            gongluePhotoUploadChange(fileUrls){
                this.ruleForm.gongluePhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
